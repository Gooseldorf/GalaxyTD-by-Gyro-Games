...
public sealed class MoreCreepCountDamageOnShootTag : OnShootTag
{
    [SerializeField, BoxGroup("Bounds")] private int minCreepsBound = 10;
    [SerializeField, BoxGroup("Bounds")] private int maxCreepsBound = 150;
    [SerializeField, BoxGroup("Bounds")] private float minPercentBound = 0.5f;
    [SerializeField, BoxGroup("Bounds")] private float maxPercentBound = 2f;
    ...
    public override string GetDescription() => LocalizationManager.GetTranslation("Tags/MoreCreepDamage");
}