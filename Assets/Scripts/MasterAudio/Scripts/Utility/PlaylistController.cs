    ...
    public class PlaylistController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (sameNameCount > 1)
            {
                ...
                if (shouldLog)
                {
                    Debug.Log("More than one Playlist Controller prefab exists in this Scene with the same name. Destroying the one called '" + ControllerName +
                              "'. You may wish to set up a Bootstrapper Scene so this does not occur.");
                }
            ...
            {
                Debug.LogWarning("One or more 'Play on Awake' checkboxes in the Audio Sources on Playlist Controller '" + name +
            ...
            if (!_activeAudio.loop && _activeAudio.clip != null)
            {
                ...
                else
                {
                    ...
                    if ((IsFrameFastEnough || isBGWebGL) && _activeAudio.clip != null)
                    {
                        ...
                        {
                            Debug.LogWarning($"Small fixes {_currentSong == null}");
                            return;
                        }
