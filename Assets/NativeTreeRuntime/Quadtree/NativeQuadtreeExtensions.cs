...
namespace NativeTrees
{
    ...
    public static class NativeQuadtreeExtensions
    {
        ...
        {
            public bool IntersectRay(in PrecomputedRay2D ray, T obj, AABB2D objBounds,out float2 closestNormal, out float distance)
            {
                return objBounds.IntersectsRay(ray.origin, ray.invDir,out closestNormal, out distance);
            }
        }
